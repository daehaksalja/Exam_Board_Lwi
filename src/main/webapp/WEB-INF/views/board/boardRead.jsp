   ...
   글제목 : ${dto.b_title} <br>
    ...
    <h1>댓글등록</h1>
       <input type="hidden" name="r_boardNum" id="r_boardNum" value="${dto.b_no}">
    	작성자 : <input type="text" name="r_writer" id="r_writer" value="${ sessionScope.m_id}" readonly="readonly">
    	글내용 : <input type="text" name="r_content" id="r_content">
    	<input type="button" name="replyRegistBtn" id="replyRegistBtn" value="등록하기">
